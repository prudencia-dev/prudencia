...
class PrudenciaReportBuilder:
    ...
    Deep Learning et RAG, puis les transforme en rapport homogène.
    """
    ...
    def _build_ai_act(
        ...
        *,
        ...
        La classification est extraite du résultat textuel.
        """
    ...
    def _build_risks(
        ...
        *,
        ...
        """
        Transforme les risques issus de l'analyse textuelle.
        """
    ...
    def _build_recommendations(
        ...
        *,
        ...
        """
        Transforme les recommandations issues de l'analyse textuelle.
        """
    ...
    def _build_conformity_status(
        ...
        *,
        ...
        status = self._first_value(
            dl_result,
            ["conformity_status", "compliance_status", "status"],
        )
